...
package ch.hearc.freescale.use.tuto.server.simulator.client;
...
public class UseTutoClientGUI
	...
	public static void main()
		{
		// Attention : changer aussi cote serveur
			{
		...
		try
			...
			VoitureGUI voitureGUI = new VoitureGUI(APP_ID, new TrameReceivedTuto());
